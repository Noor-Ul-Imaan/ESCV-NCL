...
const AppDevelopment = () => {
  const devData = useContentfulData('internsAppDevelopment');
            ...
            {devData.map((post) => (
              <div key={post.sys.id} className="border-2  rounded-lg card  ">
                ...
                <div className=" texts mt-6 text-center">
                 <Link to={post.fields.linkedIn} target="_blank"><h1 className="text-lg font-semibold">{post.fields.name}</h1></Link> 
